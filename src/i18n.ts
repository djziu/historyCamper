  ...
  ko: {
    translation: {
      ...
      era: {
        ...
        status_planned: "탐방 계획",
        status_visited: "탐방 완료",
        empty_planned: "탐방 계획으로 등록한 캠핑장이 없습니다. 캠핑장 카드 하단의 [📌 탐방 계획] 버튼을 눌러 등록해 보세요!",
        empty_visited: "탐방 완료로 등록한 캠핑장이 없습니다. 캠핑장 카드 하단의 [✅ 탐방 완료] 버튼을 눌러 등록해 보세요!",
        eras: {
          all: "전체",
          prehistoric: "선사",
          baekje: "백제",
...
songgwangsa: {
      ...
      route: {
        ...
        map: {
          ...
          gps_error_permission: "위치 접근 권한이 거부되었습니다. 브라우저 설정에서 위치 자물쇠 아이콘을 눌러 권한을 허용해 주세요.",
          gps_error_unavailable: "기기의 위치 정보(GPS)를 사용할 수 없거나 꺼져 있습니다. GPS를 활성화해 주세요.",
          gps_error_timeout: "위치 정보 요청 시간이 초과되었습니다. 다시 시도해 주세요.",
          gps_error_unsupported: "보안 연결(HTTPS) 환경이 아니거나, 브라우저가 위치 탐색을 지원하지 않습니다.",
          gps_guide_btn: "💡 설정 방법 보기",
      ...
      quiz: {
        ...
        supabase_missing_table_alert: "⚠️ Supabase 연결 완료 (하지만 favorites 테이블이 데이터베이스에 존재하지 않아, 탐방 계획/완료 데이터는 기기 로컬 저장소에 저장 중입니다. Supabase 대시보드의 SQL Editor에서 favorites 테이블을 생성해 주세요.)",
        era_select: "시대 선택",
        region_select: "지역 선택",
        all: "전체"
      }
...
songgwangsa: {
      ...
      route: {
        ...
        map: {
          ...
          gps_error_permission: "Location permission denied. Please allow location access by clicking the lock/settings icon in the address bar.",
          gps_error_unavailable: "Location services (GPS) are unavailable or disabled on your device. Please enable GPS.",
          gps_error_timeout: "Location request timed out. Please try again.",
          gps_error_unsupported: "Not a secure context (HTTPS) or geolocation is not supported by your browser.",
          gps_guide_btn: "💡 How to Allow",
