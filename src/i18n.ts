  ...
  ko: {
    translation: {
      ...
      era: {
        ...
        favorites: "즐겨찾기",
        empty_favorites: "즐겨찾기한 캠핑장이 없습니다. 마음에 드는 캠핑장의 하트(❤️) 버튼을 눌러 등록해 보세요!",
  ...
  en: {
    translation: {
      ...
      era: {
        ...
        favorites: "Saved",
        empty_favorites: "No saved campsites yet. Add campsites to favorites by clicking the heart (❤️) icon!",
        distance_km: "{{distance}}km",
        eras: {
          all: "All",
          baekje: "Baekje",
